      ...
      <div className="pesquisa">
        <div className="pesquisa-container">
          <input
            ...
            onKeyDown={(event) =>
              event.keyCode === 13 ? fetchPokemons() : null
            }
          />
          <input
            type="button"
        ...
        <div className="pesquisa-avancada">
          ...
          <section
            className={`pesquisa-avancada-content ${
              avancada ? "pesquisa-avancada-open" : "pesquisa-avancada-closed"
            }`}
          >
          ...
          <img
            className={`pesquisa-avancada-arrow`}
            onClick={() => setAvancada(!avancada)}
            src={avancada ? upArrow : downArrow}
          />
        </div>
      </div>
    </>
